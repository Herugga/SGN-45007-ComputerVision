...
##--your-code-starts-here--##
# Man
F_man = fft2(man)  # Fast fourier transformation
F_man = fftshift(F_man)  # Center the zero components to centre

# Man lowpass
F_man_lowpass = fft2(man_lowpass)
F_man_lowpass = fftshift(F_man_lowpass)

# Wolf
F_wolft = fft2(wolft)
F_wolft = fftshift(F_wolft)

# Wolf Highpass
F_wolft_highpass = fft2(wolft_highpass)
F_wolft_highpass = fftshift(F_wolft_highpass)
# --your-code-ends-here--##
